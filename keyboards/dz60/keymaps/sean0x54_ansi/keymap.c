...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------------------------------------|
     * |  LCtl  | LAlt |  LGui  |               Space             |   Fn  | RGui | RAlt  | RCtl  |
     * `-----------------------------------------------------------------------------------------'
     */
	...
	[0] = LAYOUT_60_ansi(
      ...
      KC_LCTL, KC_LALT, KC_LGUI,        KC_SPC,                         TT(1), RGUI_T(KC_LEFT),RALT_T(KC_DOWN),RCTL_T(KC_RIGHT)
	...
	[1] = LAYOUT_60_ansi(
      ...
      _______,      _______,    _______,    _______,    _______,    _______,    KC_CALC,  KC_MUTE,  KC_VOLD,    KC_VOLU,  _______,  _______,    
